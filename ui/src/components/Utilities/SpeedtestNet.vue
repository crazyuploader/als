    ...
    <n-collapse-transition :show="isQueue">
      <n-spin>
        ...
        <template #description>
          Speed test request is in queue, currently you are at position {{ queueStat.pos }} (out of {{ queueStat.total }} total)
        </template>
      </n-spin>
    </n-collapse-transition>

    <n-collapse-transition :show="!isQueue && isSpeedtest && action == '' && !isCrash">
      <n-alert :show-icon="false" :bordered="false"> The test will start shortly... </n-alert>
    </n-collapse-transition>
